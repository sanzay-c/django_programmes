...
SECRET_KEY = 'django-insecure--_7d#f+l9+lcb56q&p)$&$zrgl11s%kaklch^6d2nc9xy4-#5q'
...
BASE_URL = 'http://10.0.2.2:8000'  # Adjust this if you're using a different server URL
